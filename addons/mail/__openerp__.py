...
##############################################################################
#
#    Nantian, Open Source Management Solution
#    Copyright (C) 2010-Today Nantian S.A. (<http://www.Nantian.com.cn>).
#
...
Main Features
-------------
* Clean and renewed communication history for any Nantian document that can act as a discussion topic
