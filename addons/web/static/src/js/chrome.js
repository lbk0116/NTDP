...
instance.web.CrashManager = instance.web.Class.extend({
    ...
    rpc_error: function(error) {
        ...
        if (error.data.name === "openerp.http.SessionExpiredException" || error.data.name === "werkzeug.exceptions.Forbidden") {
            this.show_warning({type: "Session Expired", data: { message: _t("Your Nantian session expired. Please refresh the current web page.") }});
            return;
        }
    ...
    show_warning: function(error) {
        ...
        new instance.web.Dialog(this, {
            size: 'medium',
            title: "Nantian " + (_.str.capitalize(error.type) || "Warning"),
            buttons: [
    ...
    show_error: function(error) {
        ...
        new instance.web.Dialog(this, {
            title: "Nantian " + _.str.capitalize(error.type),
            buttons: buttons
...
instance.web.UserMenu =  instance.web.Widget.extend({
    ...
    on_menu_help: function() {
        window.open('http://www.nantian.com.cn', '_blank');
    },
...
instance.web.WebClient = instance.web.Client.extend({
    init: function(parent, client_options) {
        ...
        this.set('title_part', {"zopenerp": "Nantian"});
    },
    start: function() {
        var self = this;
 ...
 * Nantian webclient in an iframe, using the Cordova framework.
 *
 * This class acts as a link between the webclient and the
 * Nantian Android/iPhone App implemented with cordova.
 */
instance.web.Cordova = instance.web.Class.extend({}, instance.web.PropertiesMixin, {
    ...
    // Nantian.send('foobar') in cordova will call messages.foobar()
    messages: {
        // launch the POS !
        pos: function() {
